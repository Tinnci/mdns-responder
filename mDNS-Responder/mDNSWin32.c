 ...
 * 10/23/2018 NB-W Added linkage for external mDNSStorage, converted functions that took mDNS* to 
 *            use the global instead. This matches how other areas of bonjour are constructed.
 */
...
extern mDNS mDNSStorage;   //Stored in uds_daemon.c
